...
{
  using LinqConnectModel;
  using OrmBattle.LinqConnectModel;

  [TestFixture]
  public class LinqConnectTest : LinqTestBase
  {
    protected NorthwindDataContext db;

    public override string ToolName {
      get { return "LinqConnect"; }
    }
    ...
    public override string SourceFileName {
      get { return @"LinqConnect.generated.cs"; }
    }
    ...
    // Message:
    //   Cannot order by type 'OrmBattle.LinqConnectModel.Order'.
    ...
    // Exception: SqlException
    // Message:
    //   Column 't1.OrderDate' is invalid in the select list because it is not contained in either an aggregate function or the GROUP BY clause.
    ...
    // Exception: InvalidOperationException
    // Message:
    //   Could not retrieve a Table for inheritance subtype 'OrmBattle.LinqConnectModel.DiscontinuedProduct', try Table of OrmBattle.LinqConnectModel.Product instead.
    ...
    // Message:
    //   Object of type 'System.Func`2[aw,System.Collections.Generic.IEnumerable`1[OrmBattle.LinqConnectModel.Customer]]' cannot be converted to type 'System.Func`2[aw,OrmBattle.LinqConnectModel.Customer]'.
    ...
    // Exception: NotSupportedException
    // Message:
    //   Method 'LastIndexOf' has no supported translation to SQL.
    ...
    // Exception: NotSupportedException
    // Message:
    //   Method 'PadLeft' has no supported translation to SQL.
