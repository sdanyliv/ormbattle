...
namespace OrmBattle.Tests.Linq
{
  ...
  public class BLToolkitTest : LinqTestBase
  {
    ...
    // Message:
    //   'new <>f__AnonymousType0`2(City = o.ShipCity, Region = o.ShipRegion)' cannot be converted to SQL.
    ...
    // Exception: ArgumentException
    // Message:
    //   Queryable method call expected. Got 'Table(Order)'.
    //   Parameter name: info
    ...
    // Exception: LinqException
    // Message:
    //   'g.Count()' cannot be converted to SQL.
    ...
    // Exception: SqlException
    // Message:
    //   Column 'Orders.Freight' is invalid in the select list because it is not contained in either an aggregate function or the GROUP BY clause.
    ...
    // Exception: LinqException
    // Message:
    //   'c.Orders.Average(o => o.Freight)' cannot be converted to SQL.
    ...
    // Exception: LinqException
    // Message:
    //   Cannot find converter for the 'OrmBattle.BLToolkitModel.Product' type.
    ...
    // Exception: LinqException
    // Message:
    //   Cannot find converter for the 'System.Object' type.
    ...
    // Exception: LinqException
    // Message:
    //   'c.Orders.Count()' cannot be converted to SQL.
    ...
    // Exception: ArgumentException
    // Message:
    //   Queryable method call expected. Got 'Table(Order).Count(o => (o.Id > 10))'.
    //   Parameter name: info
    ...
    // Exception: ArgumentException
    // Message:
    //   Queryable method call expected. Got 'Table(Customer).Max(c => value(OrmBattle.Tests.Linq.BLToolkitTest).db.Orders.Count(o => (o.Customer.Id = c.Id)))'.
    //   Parameter name: info
    ...
    // Exception: LinqException
    // Message:
    //   'od.Product.Category.CategoryName' cannot be converted to SQL.
    ...
    // Exception: LinqException
    // Message:
    //   'c.Products.Count' cannot be converted to SQL.
