...
namespace OrmBattle.Tests.Linq
{
  ...
  using OrmBattle.LLBLGenModel.Northwind.Linq;
  using Category = LLBLGenModel.Northwind.EntityClasses.CategoriesEntity;
  using Customer = LLBLGenModel.Northwind.EntityClasses.CustomersEntity;
  using Employee = LLBLGenModel.Northwind.EntityClasses.EmployeesEntity;
  using Order = LLBLGenModel.Northwind.EntityClasses.OrdersEntity;
  using OrderDetail = LLBLGenModel.Northwind.EntityClasses.OrderDetailsEntity;
  using Product = LLBLGenModel.Northwind.EntityClasses.ProductsEntity;
  using DiscontinuedProduct = LLBLGenModel.Northwind.EntityClasses.DiscontinuedProductsEntity;
  using Supplier = LLBLGenModel.Northwind.EntityClasses.SuppliersEntity;
  
  [TestFixture]
  public class LLBLGenTest
  {
    protected LinqMetaData db;
