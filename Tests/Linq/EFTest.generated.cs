...
namespace OrmBattle.Tests.Linq
{
  ...
  public class EFTest : LinqTestBase
  {
    ...
    // Exception: NotSupportedException
    // Message:
    //   LINQ to Entities does not recognize the method 'System.Collections.Generic.IEnumerable`1[<>f__AnonymousType6`2[System.Int32,System.String]] DefaultIfEmpty[<>f__AnonymousType6`2](System.Collections.Generic.IEnumerable`1[<>f__AnonymousType6`2[System.Int32,System.String]])' method, and this method cannot be translated into a store expression.
    ...
    // Exception: NotSupportedException
    // Message:
    //   LINQ to Entities does not recognize the method 'Boolean Contains[Customer](System.Linq.IQueryable`1[OrmBattle.EFModel.Customer], OrmBattle.EFModel.Customer)' method, and this method cannot be translated into a store expression.
    ...
    // Exception: NotSupportedException
    // Message:
    //   LINQ to Entities does not recognize the method 'System.Collections.Generic.IEnumerable`1[OrmBattle.EFModel.Product] DefaultIfEmpty[Product](System.Collections.Generic.IEnumerable`1[OrmBattle.EFModel.Product])' method, and this method cannot be translated into a store expression.
    ...
    // Exception: NotSupportedException
    // Message:
    //   LINQ to Entities does not recognize the method 'Boolean Contains(OrmBattle.EFModel.Order)' method, and this method cannot be translated into a store expression.
    ...
    // Exception: NotSupportedException
    // Message:
    //   LINQ to Entities does not recognize the method 'Int32 Abs(Int32)' method, and this method cannot be translated into a store expression.
    ...
    // Exception: NotSupportedException
    // Message:
    //   LINQ to Entities does not recognize the method 'System.Decimal Round(System.Decimal, Int32)' method, and this method cannot be translated into a store expression.
