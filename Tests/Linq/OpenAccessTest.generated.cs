...
namespace OrmBattle.Tests.Linq
{
  ...
  public class OpenAccessTest : LinqTestBase
  {
    ...
    // Exception: NotSupportedException
    // Message:
    //   OrderExtent.OrderBy(o => o.OrderDate).Skip(100).Take(50).OrderBy(o => o.RequiredDate).Where(o => (o.OrderDate != Convert(null))).Select(o => o.RequiredDate).Distinct()
    ...
    // Exception: NotSupportedException
    // Message:
    //   CustomerExtent.OrderBy(c => c.CompanyName).Select(c => c.City).Distinct()
    ...
    // Exception: OpenAccessException
    // Message:
    //   Invalid node in orders: AndNode@268573c
    ...
    // Exception: OpenAccessException
    // Message:
    //   Invalid projection type used. (OpenAccessRuntime.DataObjects.query.CompareOpNode)
    ...
    // Exception: NotSupportedException
    // Message:
    //   OrderExtent.Select(c => c.Freight).Distinct()
    ...
    // Exception: NotSupportedException
    // Message:
    //   OrderExtent.OrderBy(o => o.OrderDate).Select(o => o.OrderDate).Distinct()
    ...
    // Exception: NotSupportedException
    // Message:
    //   OrderExtent.OrderBy(o => o.OrderDate).Select(o => o.OrderDate).Take(5).Distinct()
    ...
    // Exception: NotSupportedException
    // Message:
    //   CustomerExtent.Select(c => new <>f__AnonymousTypeb`2(Region = c.Region, City = c.City)).Distinct()
    ...
    // Exception: NotSupportedException
    // Message:
    //   Using a JOIN directly is currently not supported as database server operation.
