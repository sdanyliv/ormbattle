...
namespace OrmBattle.Tests.Linq
{
  ...
  public class Linq2SqlTest : LinqTestBase
  {
    ...
    // Exception: InvalidOperationException
    // Message:
    //   Data member 'Int32 Id' of type 'Linq2SqlModel.Product' is not part of the mapping for type 'DiscontinuedProduct'. Is the member above the root of an inheritance hierarchy?
