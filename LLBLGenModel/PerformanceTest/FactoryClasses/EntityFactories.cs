...
using OrmBattle.LLBLGenModel.PerformanceTest.RelationClasses;
...
namespace OrmBattle.LLBLGenModel.PerformanceTest.FactoryClasses
{
	...
	public partial class EntityFactoryBase : EntityFactoryCore
	{
		...
		private LLBLGenModel.PerformanceTest.EntityType _typeOfEntity;
		
		/// <summary>CTor</summary>
		/// <param name="entityName">Name of the entity.</param>
		/// <param name="typeOfEntity">The type of entity.</param>
		public EntityFactoryBase(string entityName, LLBLGenModel.PerformanceTest.EntityType typeOfEntity)
		{
		...
		{
			return GeneralEntityFactory.Create((LLBLGenModel.PerformanceTest.EntityType)entityTypeValue);
		}
	...
	/// <summary>Factory to create new, empty SimplestEntity objects.</summary>
	[Serializable]
	public partial class SimplestEntityFactory : EntityFactoryBase {
		/// <summary>CTor</summary>
		public SimplestEntityFactory() : base("SimplestEntity", LLBLGenModel.PerformanceTest.EntityType.SimplestEntity) { }

		/// <summary>Creates a new, empty SimplestEntity object.</summary>
		/// <returns>A new, empty SimplestEntity object.</returns>
		public override IEntity Create() {
			IEntity toReturn = new SimplestEntity();
			
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewSimplest
			// __LLBLGENPRO_USER_CODE_REGION_END
			
			return toReturn;
		}
		
		/// <summary>Creates a new SimplestEntity instance and will set the Fields object of the new IEntity instance to the passed in fields object.</summary>
		...
		public override IEntity Create(IEntityFields fields) {
			...
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewSimplestUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
	...
	public partial class GeneralEntityCollectionFactory
	{
		...
		public static IEntityCollection Create(LLBLGenModel.PerformanceTest.EntityType typeToUse)
		{
			switch(typeToUse)
			{
				case LLBLGenModel.PerformanceTest.EntityType.SimplestEntity:
					return new SimplestCollection();
				default:
					return null;
			}
		}		
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity Create(LLBLGenModel.PerformanceTest.EntityType entityTypeToCreate)
		{
			IEntityFactory factoryToUse = null;
			switch(entityTypeToCreate)
			{
				case LLBLGenModel.PerformanceTest.EntityType.SimplestEntity:
					factoryToUse = new SimplestEntityFactory();
					break;
			}
	...
	{
#if CF
		/// <summary>Gets the factory of the entity with the LLBLGenModel.PerformanceTest.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory GetFactory(LLBLGenModel.PerformanceTest.EntityType typeOfEntity)
		{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(LLBLGenModel.PerformanceTest.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity dummy = GeneralEntityFactory.Create((LLBLGenModel.PerformanceTest.EntityType)entityTypeValue);
	...
	{
		/// <summary>Gets the factory of the Entity type with the LLBLGenModel.PerformanceTest.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (LLBLGenModel.PerformanceTest.EntityType)Enum.Parse(typeof(LLBLGenModel.PerformanceTest.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation((LLBLGenModel.PerformanceTest.EntityType)Enum.Parse(typeof(LLBLGenModel.PerformanceTest.EntityType), leftOperandEntityName, false), joinType, (LLBLGenModel.PerformanceTest.EntityType)Enum.Parse(typeof(LLBLGenModel.PerformanceTest.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		...
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the LLBLGenModel.PerformanceTest.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((LLBLGenModel.PerformanceTest.EntityType)entityTypeValue);
		}
#if !CF		
