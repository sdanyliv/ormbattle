...
namespace OrmBattle.LLBLGenModel.PerformanceTest.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Simplest Entity. It will perform database oriented actions for
	/// a entity of type 'SimplestEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class SimplestDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public SimplestDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "SimplestEntity", new SimplestEntityFactory())
		{
		}
		...
		internal SimplestDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'SimplestEntity' in a datatable which match the specified filter. 
