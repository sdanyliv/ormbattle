...
namespace OrmBattle.LLBLGenModel.Northwind.HelperClasses
{
	...
	internal class InheritanceInfoProviderCore : InheritanceInfoProviderBase
	{
		...
		private void Init()
		{
			base.AddEntityInfo("ActiveProductsEntity", "ProductsEntity", new ActiveProductsEntityFactory(), (int)ActiveProductsFieldIndex.Discontinued, "0");
			base.AddEntityInfo("DiscontinuedProductsEntity", "ProductsEntity", new DiscontinuedProductsEntityFactory(), (int)DiscontinuedProductsFieldIndex.Discontinued, "1");
			base.AddEntityInfo("ProductsEntity", string.Empty, new ProductsEntityFactory(), (int)ProductsFieldIndex.Discontinued, "");
