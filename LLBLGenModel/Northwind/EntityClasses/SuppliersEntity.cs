...
namespace OrmBattle.LLBLGenModel.Northwind.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Suppliers'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class SuppliersEntity : CommonEntityBase, ISerializable
			...
			
	{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Suppliers which data should be fetched into this Suppliers object</param>
		public SuppliersEntity(System.Int32 id)
		{
		...
		public SuppliersEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		public SuppliersEntity(System.Int32 id, IValidator validator)
		{
		...
		{
			switch((SuppliersFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return SuppliersEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Products":
					toReturn.Add(SuppliersEntity.Relations.ProductsEntityUsingSupplierId);
					break;
		...
		public bool TestOriginalFieldValueForNull(SuppliersFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(SuppliersFieldIndex fieldIndex)
		{
		...
		public virtual LLBLGenModel.Northwind.CollectionClasses.ProductsCollection GetMultiProducts(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedProducts || forceFetch || _alwaysFetchProducts) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_products.GetMultiManyToOne(null, this, filter);
		...
		{
			SuppliersDAO dao = (SuppliersDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(LLBLGenModel.Northwind.EntityType.SuppliersEntity);
		}
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)SuppliersFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return DAOFactory.CreateSuppliersDAO();
		}
		...
		{
			return new SuppliersEntityFactory();
		}
		...
		public static IPrefetchPathElement PrefetchPathProducts
		{
			get
			{
				return new PrefetchPathElement(new LLBLGenModel.Northwind.CollectionClasses.ProductsCollection(),
					(IEntityRelation)GetRelationsForField("Products")[0], (int)LLBLGenModel.Northwind.EntityType.SuppliersEntity, (int)LLBLGenModel.Northwind.EntityType.ProductsEntity, 0, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		{
			get { return SuppliersEntity.CustomProperties;}
		}
		...
		{
			get { return SuppliersEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		{
			get { return (System.Int32)GetValue((int)SuppliersFieldIndex.Id, true); }
			set	{ SetValue((int)SuppliersFieldIndex.Id, value, true); }
		}
		/// <summary> The CompanyName property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String CompanyName
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.CompanyName, value, true); }
		}
		/// <summary> The ContactName property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String ContactName
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.ContactName, value, true); }
		}
		/// <summary> The ContactTitle property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String ContactTitle
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.ContactTitle, value, true); }
		}
		/// <summary> The Address property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String Address
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.Address, value, true); }
		}
		/// <summary> The City property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String City
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.City, value, true); }
		}
		/// <summary> The Region property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String Region
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.Region, value, true); }
		}
		/// <summary> The PostalCode property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String PostalCode
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.PostalCode, value, true); }
		}
		/// <summary> The Country property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String Country
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.Country, value, true); }
		}
		/// <summary> The Phone property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String Phone
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.Phone, value, true); }
		}
		/// <summary> The Fax property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String Fax
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.Fax, value, true); }
		}
		/// <summary> The HomePage property of the Entity Suppliers<br/><br/>
		/// </summary>
		...
		public virtual System.String HomePage
		{
			...
			set	{ SetValue((int)SuppliersFieldIndex.HomePage, value, true); }
		}
		...
		{ 
			get { return (int)LLBLGenModel.Northwind.EntityType.SuppliersEntity; }
		}
		#endregion
