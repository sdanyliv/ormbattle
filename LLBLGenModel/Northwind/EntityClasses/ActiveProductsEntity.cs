...
namespace OrmBattle.LLBLGenModel.Northwind.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ActiveProducts'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ActiveProductsEntity : ProductsEntity, ISerializable
			...
			
	{
		...
		static ActiveProductsEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ActiveProductsEntity()
		{
		...
		protected ActiveProductsEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ActiveProductsFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ActiveProductsEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ActiveProductsEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ActiveProductsEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ActiveProductsEntity", negate);
		}
		...
		/// <param name="id">PK value for ActiveProducts which data should be fetched into this ActiveProducts object</param>
		...
		public static new ActiveProductsEntity FetchPolymorphic(ITransaction transactionToUse, System.Int32 id, Context contextToUse)
		{
		...
		/// <returns>Fetched entity of the type of this entity or a subtype, or an empty entity of that type if not found.</returns>
		/// <remarks>Creates a new instance, doesn't fill <i>this</i> entity instance</remarks>
		public static new ActiveProductsEntity FetchPolymorphic(ITransaction transactionToUse, System.Int32 id, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			ActiveProductsDAO dao = new ActiveProductsDAO();
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(LLBLGenModel.Northwind.EntityType.ActiveProductsEntity);
			fields[(int)ActiveProductsFieldIndex.Id].ForcedCurrentValueWrite(id);
			return (ActiveProductsEntity)dao.FetchExistingPolymorphic(transactionToUse, fields, contextToUse, excludedIncludedFields);
		}
		...
		public bool TestOriginalFieldValueForNull(ActiveProductsFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ActiveProductsFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ActiveProductsEntity", ((LLBLGenModel.Northwind.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new ActiveProductsRelations().GetAllRelations();
		}
		...
		{
			ActiveProductsDAO dao = (ActiveProductsDAO)CreateDAOInstance();
		...
		protected override void InitClassEmpty(IValidator validatorToUse)
		{
			...
			{
				base.Fields[(int)ActiveProductsFieldIndex.Discontinued].ForcedCurrentValueWrite("0");
			}
			InitClassMembers();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(LLBLGenModel.Northwind.EntityType.ActiveProductsEntity);
		}
		...
		/// <param name="id">PK value for ActiveProducts which data should be fetched into this ActiveProducts object</param>
		/// <param name="validator">The validator object for this ActiveProductsEntity</param>
		...
		{
			return DAOFactory.CreateActiveProductsDAO();
		}
		...
		{
			return new ActiveProductsEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public new static ActiveProductsRelations Relations
		{
			get	{ return new ActiveProductsRelations(); }
		}
		...
		{
			get { return "ActiveProductsEntity";}
		}
		...
		{
			get { return ActiveProductsEntity.CustomProperties;}
		}
		...
		{
			get { return ActiveProductsEntity.FieldsCustomProperties;}
		}
		...
		{ 
			get { return (int)LLBLGenModel.Northwind.EntityType.ActiveProductsEntity; }
		}
		#endregion
