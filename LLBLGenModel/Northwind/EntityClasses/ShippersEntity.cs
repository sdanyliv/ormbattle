...
namespace OrmBattle.LLBLGenModel.Northwind.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Shippers'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ShippersEntity : CommonEntityBase, ISerializable
			...
			
	{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Shippers which data should be fetched into this Shippers object</param>
		public ShippersEntity(System.Int32 id)
		{
		...
		public ShippersEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Shippers which data should be fetched into this Shippers object</param>
		/// <param name="validator">The custom validator object for this ShippersEntity</param>
		public ShippersEntity(System.Int32 id, IValidator validator)
		{
		...
		protected ShippersEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ShippersFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ShippersEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Orders":
					toReturn.Add(ShippersEntity.Relations.OrdersEntityUsingShipVia);
					break;
		...
		public bool TestOriginalFieldValueForNull(ShippersFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ShippersFieldIndex fieldIndex)
		{
		...
		{
			return new ShippersRelations().GetAllRelations();
		}
		...
		{
			ShippersDAO dao = (ShippersDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(LLBLGenModel.Northwind.EntityType.ShippersEntity);
		}
		...
		/// <param name="id">PK value for Shippers which data should be fetched into this Shippers object</param>
		/// <param name="validator">The validator object for this ShippersEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)ShippersFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return new ShippersEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static ShippersRelations Relations
		{
			get	{ return new ShippersRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathOrders
		{
			get
			{
				return new PrefetchPathElement(new LLBLGenModel.Northwind.CollectionClasses.OrdersCollection(),
					(IEntityRelation)GetRelationsForField("Orders")[0], (int)LLBLGenModel.Northwind.EntityType.ShippersEntity, (int)LLBLGenModel.Northwind.EntityType.OrdersEntity, 0, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		{
			get { return ShippersEntity.CustomProperties;}
		}
		...
		{
			get { return ShippersEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity Shippers<br/><br/>
		/// </summary>
		...
		{
			get { return (System.Int32)GetValue((int)ShippersFieldIndex.Id, true); }
			set	{ SetValue((int)ShippersFieldIndex.Id, value, true); }
		}
		/// <summary> The CompanyName property of the Entity Shippers<br/><br/>
		/// </summary>
		...
		{
			get { return (System.String)GetValue((int)ShippersFieldIndex.CompanyName, true); }
			set	{ SetValue((int)ShippersFieldIndex.CompanyName, value, true); }
		}
		/// <summary> The Phone property of the Entity Shippers<br/><br/>
		/// </summary>
		...
		{
			get { return (System.String)GetValue((int)ShippersFieldIndex.Phone, true); }
			set	{ SetValue((int)ShippersFieldIndex.Phone, value, true); }
		}
		...
		{ 
			get { return (int)LLBLGenModel.Northwind.EntityType.ShippersEntity; }
		}
		#endregion
