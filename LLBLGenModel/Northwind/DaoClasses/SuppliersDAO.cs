...
namespace OrmBattle.LLBLGenModel.Northwind.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Suppliers Entity. It will perform database oriented actions for
	/// a entity of type 'SuppliersEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class SuppliersDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public SuppliersDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "SuppliersEntity", new SuppliersEntityFactory())
		{
		}
		...
		internal SuppliersDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'SuppliersEntity' in a datatable which match the specified filter. 
