...
namespace OrmBattle.LLBLGenModel.Northwind.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Regions Entity. It will perform database oriented actions for
	/// a entity of type 'RegionsEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class RegionsDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public RegionsDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "RegionsEntity", new RegionsEntityFactory())
		{
		}
		...
		internal RegionsDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'RegionsEntity' in a datatable which match the specified filter. 
