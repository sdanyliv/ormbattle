...
namespace OrmBattle.LLBLGenModel.Northwind.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Shippers Entity. It will perform database oriented actions for
	/// a entity of type 'ShippersEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class ShippersDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public ShippersDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "ShippersEntity", new ShippersEntityFactory())
		{
		}
		...
		internal ShippersDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'ShippersEntity' in a datatable which match the specified filter. 
