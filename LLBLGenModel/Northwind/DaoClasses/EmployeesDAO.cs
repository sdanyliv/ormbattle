...
namespace OrmBattle.LLBLGenModel.Northwind.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Employees Entity. It will perform database oriented actions for
	/// a entity of type 'EmployeesEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class EmployeesDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public EmployeesDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "EmployeesEntity", new EmployeesEntityFactory())
		{
		}
		...
		internal EmployeesDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'EmployeesEntity' in a datatable which match the specified filter. 
