...
namespace OrmBattle.EFCoreModel
{
    public partial class NorthwindContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=.;initial catalog=Northwind;Integrated Security=SSPI");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasDiscriminator(e => e.Discontinued)
                    .HasValue<DiscontinuedProduct>(true)
                    .HasValue<Products>(false);
