...
{
    public partial class PerformanceTestDB : IQuerySurface
    {
        ...
        { 
            DataProvider = ProviderFactory.GetProvider("PerformanceTest");
            Init();
        }

        public PerformanceTestDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public PerformanceTestDB(string connectionString, string providerName)
        {
