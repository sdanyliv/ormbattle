...
namespace Linq2SqlModel
{
    ...
    partial void DeleteCategory(Category instance);
		...
		public NorthwindDataContext() : 
				base(global::Linq2SqlModel.Properties.Settings.Default.NorthwindConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnRegionIDChanged();
		...
		[Association(Name="Region_Territory", Storage="_Region", ThisKey="RegionID", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnHomePageChanged();
		...
		[Column(Name="SupplierID", Storage="_Id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Id
		{
			get
			{
		...
		[Association(Name="Supplier_Product", Storage="_Products", ThisKey="Id", OtherKey="SupplierID")]
    ...
    partial void OnPhoneChanged();
		...
		[Column(Name="ShipperID", Storage="_Id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Id
		{
			get
			{
		...
		[Association(Name="Shipper_Order", Storage="_Orders", ThisKey="Id", OtherKey="ShipVia")]
    ...
    partial void OnRegionDescriptionChanged();
		...
		[Column(Name="RegionID", Storage="_Id", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int Id
		{
			get
			{
		...
		[Association(Name="Region_Territory", Storage="_Territories", ThisKey="Id", OtherKey="RegionID")]
    ...
    partial void OnDiscontinuedChanged();
		...
		[Column(Name="ProductID", Storage="_Id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Id
		{
			get
			{
		...
		[Column(Storage="_Discontinued", DbType="Bit NOT NULL", IsDiscriminator=true)]
		...
		[Association(Name="Product_OrderDetail", Storage="_OrderDetails", ThisKey="Id", OtherKey="ProductID")]
		...
		[Association(Name="Supplier_Product", Storage="_Supplier", ThisKey="SupplierID", OtherKey="Id", IsForeignKey=true)]
		...
		[Association(Name="Category_Product", Storage="_Category", ThisKey="CategoryID", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnShipCountryChanged();
		...
		[Column(Name="OrderID", Storage="_Id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Id
		{
			get
			{
		...
		[Association(Name="Order_OrderDetail", Storage="_OrderDetails", ThisKey="Id", OtherKey="OrderID")]
		public EntitySet<OrderDetail> OrderDetails
		{
			get
			{
		...
		[Association(Name="Shipper_Order", Storage="_Shipper", ThisKey="ShipVia", OtherKey="Id", IsForeignKey=true)]
		...
		[Association(Name="Employee_Order", Storage="_Employee", ThisKey="EmployeeID", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnDiscountChanged();
		...
		[Association(Name="Order_OrderDetail", Storage="_Order", ThisKey="OrderID", OtherKey="Id", IsForeignKey=true)]
		public Order Order
		{
			get
			{
		...
		[Association(Name="Product_OrderDetail", Storage="_Product", ThisKey="ProductID", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnTerritoryIDChanged();
		...
		[Association(Name="Employee_EmployeeTerritory", Storage="_Employee", ThisKey="EmployeeID", OtherKey="Id", IsForeignKey=true)]
		public Employee Employee
		{
			get
			{
    ...
    partial void OnPhotoPathChanged();
		...
		[Column(Name="EmployeeID", Storage="_Id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Id
		{
			get
			{
		...
		[Association(Name="Employee_Order", Storage="_Orders", ThisKey="Id", OtherKey="EmployeeID")]
		public EntitySet<Order> Orders
		{
			get
			{
		...
		[Association(Name="Employee_EmployeeTerritory", Storage="_EmployeeTerritories", ThisKey="Id", OtherKey="EmployeeID")]
		public EntitySet<EmployeeTerritory> EmployeeTerritories
		{
			get
			{
		...
		[Association(Name="Employee_Employee", Storage="_Employees", ThisKey="Id", OtherKey="ReportsTo")]
		...
		[Association(Name="Employee_Employee", Storage="_Employee1", ThisKey="ReportsTo", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnFaxChanged();
		...
		[Column(Name="CustomerID", Storage="_Id", DbType="NChar(5) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string Id
		{
			get
			{
		...
		[Association(Name="Customer_CustomerCustomerDemo", Storage="_CustomerCustomerDemos", ThisKey="Id", OtherKey="CustomerID")]
    ...
    partial void OnCustomerTypeIDChanged();
		...
		[Association(Name="Customer_CustomerCustomerDemo", Storage="_Customer", ThisKey="CustomerID", OtherKey="Id", IsForeignKey=true)]
		public Customer Customer
		{
			get
			{
    ...
    partial void OnPictureChanged();
		...
		[Column(Name="CategoryID", Storage="_Id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Id
		{
			get
			{
		...
		[Association(Name="Category_Product", Storage="_Products", ThisKey="Id", OtherKey="CategoryID")]
		public EntitySet<Product> Products
		{
			get
			{
